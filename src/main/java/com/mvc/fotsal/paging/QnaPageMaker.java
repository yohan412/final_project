...
public class QnaPageMaker {
    ...
    private QnaBoardPaging TLP;
    
    public void setTLP(QnaBoardPaging TLP){
        this.TLP = TLP;
    }
	...
	public String makeSearch(int page) {
		 ...
		 UriComponents uriComponents =
		            ...
		            .queryParam("page", page)
		            .queryParam("perPageNum", TLP.getPerPageNum())
		            .queryParam("searchType", ((QnaSearch)TLP).getSearchType())
		            .queryParam("keyword", encoding(((QnaSearch)TLP).getKeyword()))
		            .build(); 
		    return uriComponents.toUriString();  
		}
