...
<section>
	...
	<div class="user_info" align="center">
			...
			<div class="content-submit-list" style="margin-left: 270px;">
				<button id="pointer" type="button" onclick="location.href='aupdateform.do?user_id=${aDto.user_id}'">수정</button>
				<button id="pointer" type="button" onclick="location.href='adelete.do?user_id=${aDto.user_id}'">회원탈퇴</button>
			</div>	
	</div>
</section>
